...
def index():
    ...
    products = [p for p in products if (p.seller_id is None) or _seller_active(p.seller)]
    ...
    return render_template('merch/index.html', products=products, search=search, seller_ratings=rating_map)
